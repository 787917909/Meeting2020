package com.example.meeting2020.adapter;
...
import com.example.meeting2020.activity.EditNoteActivity;
import com.example.meeting2020.activity.LetteryActivity;
import com.example.meeting2020.activity.MainLotteryActivity;
import com.example.meeting2020.entity.Mainlottery;
import com.example.meeting2020.gson.Note;
    ...
    public ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtras(EditNoteActivity.newInstanceBundle(notes.get(viewHolder.getAdapterPosition()).getId(),notes.get(viewHolder.getAdapterPosition()).getMeetingid()) );
